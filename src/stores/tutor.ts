  ...
  state: () => ({
    ...
    cases: [
      ...
      },
      {
        ...
        duration: '9 місяців',
        text: '2. Наибольшее удовольствие от занятий приносил сам учитель, объясняет очень понятно, спокойно, не сильно давит, а самое главное, общее настроение уроков который был похож по уровню с общением с хорошим другом и просто приятная атмосфера, порой я хотел заниматься лишь для того чтобы пообщаться с учителем. 3. После уроков мой уровень очень поднялся со временем ( в среднем у меня оценки стали 4-5), а для себя я понял что не зря все это было и очень доволен нынешними достижениями',
        badge: 'Загальна підготовка'
      }
    ] as CaseStudy[],
    ...
    reviews: [
      ...
      {
        author: 'Михайло',
        text: 'Наибольшее удовольствие от занятий приносил сам учитель, объясняет очень понятно, спокойно, не сильно давит, а самое главное, общее настроение уроков который был похож по уровню с общением с хорошим другом и просто приятная атмосфера, порой я хотел заниматься лишь для того чтобы пообщаться с учителем. После уроков мой уровень очень поднялся со временем ( в среднем у меня оценки стали 4-5), а для себя я понял что не зря все это было и очень доволен нынешними достижениями',
        subText: '2-й курс польського технікуму'
      },
      {
